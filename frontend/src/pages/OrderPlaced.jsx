...
function OrderPlaced(){
    ...
    return(
        ...
        px-4 text-center relative overflow-hidden">
            ...
            <button className="bg-[#ff4d2d] hover:bg-[#e64526] text-white *:px-6 py-3 
            rounded-lg text-lg font-medium transition" onClick={()=>navigate("/my-orders")}>Back to my orders</button>
